...
```
Task(
  prompt="Read /Users/sylvanfranklin/.config/opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/sylvanfranklin/.config/opencode/get-shit-done/templates/VALIDATION.md`
