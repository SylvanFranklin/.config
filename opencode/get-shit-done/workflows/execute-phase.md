...
2. **Spawn executor agents:**
   ...
   Task(
     ...
     prompt="
       ...
       @/Users/sylvanfranklin/.config/opencode/get-shit-done/references/tdd.md
       </execution_context>
...
Read and follow `/Users/sylvanfranklin/.config/opencode/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
